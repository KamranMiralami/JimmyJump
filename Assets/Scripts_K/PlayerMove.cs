...
public class PlayerMove : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        cameraOffsetPercentage += Time.deltaTime * 0.1f;
        ...
        cameraFollow.offset.x = Mathf.Lerp(cf.x, cf.x + direction.x * 3, cameraOffsetPercentage);
        cameraFollow.offset.z = Mathf.Lerp(cf.z, cf.z + direction.z * 3, cameraOffsetPercentage);
    }
}
